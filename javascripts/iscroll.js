...
//	this.options.bounceEasing = typeof this.options.bounceEasing == 'string' ? utils.ease[this.options.bounceEasing] || utils.ease.bounce : this.options.bounceEasing;
...
Indicator.prototype = {
	...
	updatePosition: function () {
		...
		//	this.indicatorStyle[utils.style.transform] = 'translate(' + x + 'px,' + y + 'px)' + this.scroller.translateZ;
			this.indicatorStyle[utils.style.transform] = 'translate3d(' + x + 'px,' + y + 'px, 0px)';
		} else {
